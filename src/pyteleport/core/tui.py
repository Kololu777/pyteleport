...
class SelectFromListTUI:
    ...
    def _get_style(self):
        style = Style.from_dict(
            {
                "selected": "#2C3E50 #F1C40F bold",  # 濃紺背景に黄金色の文字（コントラスト高く個性的）
                "unselected": "default #FFFFFF",  # 選択されていない項目は白文字に
                "bar.active": "#F1C40F bold",  # アクティブバーは黄金色で統一
                "bar.inactive": "#7F8C8D",  # 非アクティブバーは落ち着いたグレー
            }
        )
        return style
